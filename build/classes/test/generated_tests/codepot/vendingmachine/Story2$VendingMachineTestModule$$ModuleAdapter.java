 ...
 */
public final class Story2$VendingMachineTestModule$$ModuleAdapter extends ModuleAdapter<Story2.VendingMachineTestModule> {
  private static final String[] INJECTS = { };
  private static final Class<?>[] STATIC_INJECTIONS = { };
  private static final Class<?>[] INCLUDES = { };

  public Story2$VendingMachineTestModule$$ModuleAdapter() {
    super(codepot.vendingmachine.Story2.VendingMachineTestModule.class, INJECTS, STATIC_INJECTIONS, true /*overrides*/, INCLUDES, true /*complete*/, true /*library*/);
  }
   ...
   */
  @Override
  public void getBindings(BindingsGroup bindings, Story2.VendingMachineTestModule module) {
  ...
  public static final class ProductStorageServiceNotifiersProvidesAdapter extends ProvidesBinding<java.util.List<codepot.vendingmachine.infrastructure.notifiers.ServiceNotifier>>
    ...
    private final Story2.VendingMachineTestModule module;

    public ProductStorageServiceNotifiersProvidesAdapter(Story2.VendingMachineTestModule module) {
      super("java.util.List<codepot.vendingmachine.infrastructure.notifiers.ServiceNotifier>", IS_SINGLETON, "codepot.vendingmachine.Story2.VendingMachineTestModule", "productStorageServiceNotifiers");
      this.module = module;
      setLibrary(true);
    }
